...
export function createOutlineRouter() {
  ...
  router.post(
    '/',
    ownStory,
    validateBody(outlineCreateSchema, async (body, req, res) => {
      const storyId = req.params.storyId as string;
  ...
  router.patch(
    '/reorder',
    ownStory,
    validateBody(outlineReorderSchema, async (body, req, res) => {
      const storyId = req.params.storyId as string;
  ...
  router.patch(
    ...
    ownStory,
    ownOutline,
    validateBody(outlineUpdateSchema, async (body, req, res) => {
      const storyId = req.params.storyId as string;
      const outlineId = req.params.outlineId as string;
