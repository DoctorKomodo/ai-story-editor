...
- **Backlog (next):** M1–M3 maintenance, X27, X28, X30, X31 testing-found UI/settings polish.
- **Proposed (no plan yet):** X1, X2, X3, X4, X5, X6, X7, X8, X9, X11, X17, X18, X27, X28, X30, X31, DS-* (none yet).
